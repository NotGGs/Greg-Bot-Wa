...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (opts['gconly'] && !m.fromMe && !m.chat.endsWith('g.us')) return await conn.sendMessage(m.chat, { text: "*Maaf kak*\nReel Bot Tidak Bisa Digunakan digunakan di private chat\n\n_Hanya Bisa Digunakan Di Dalam Group_\n\nKlik bergabung ke grup\nJika Ingin Menggunakan Bot Ini.",   contextInfo: { externalAdReply: { showAdAttribution: true, title: "GROUP ONLY MODE",  body: wm,   thumbnailUrl: "https://i.ibb.co/pnRZs1v/31d3h8.jpg", sourceUrl: sgc, mediaType: 1,   renderLargerThumbnail: true }}}, { quoted: m})
...
global.dfail = (type, m, conn) => {
    let reelthumb = 'https://telegra.ph/file/485ace354ab59724fb0ca.jpg'
    let msg = {
