let handler = async (m, { conn, usedPrefix, command }) => {
    await conn.sendButton(m.chat, `“${pickRandom(global.gombal)}”`, '2023 © 𝕳𝖆𝖎𝖐𝖆𝖑 𝖃 𝕲𝖗𝖊𝖌𝖔𝖗𝖎𝖚𝖘 𝕭𝖔𝖙', 'Gombal', [['Gombal', `${usedPrefix}gombal`], ['Menu', '.menu']], m)
    conn.sendFile(m.chat, './mp3/Uwuuu.mp3', '', null, m, true, { type: "audioMessage", ptt: true, fileLength: 88738 })
}
handler.help = ['gombal']
handler.tags = ['quotes']
